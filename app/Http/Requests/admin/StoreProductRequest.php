...
class StoreProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'discount_price' => ['nullable', 'numeric', 'min:0', 'required_if:has_variants,0'],
            'image' => ['nullable'], // No restriction on file type or size
    ...
    public function messages(): array
    {
        return [
            ...
            'discount_price.required_if' => 'Discount price is required for simple products.',
