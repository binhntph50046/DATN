...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // For simple products (has_variants = 0)
            ...
            // For variant products (has_variants = 1)
            'variants' => [
            ...
            'product_attributes.*.hex' => ['nullable', 'string', 'max:7', 'regex:/^#[0-9A-Fa-f]{6}$/', 'required_with:product_attributes.*.attribute_type_id'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'product_attributes.*.hex.required_with' => 'The hex code is required when an attribute type is selected.',
