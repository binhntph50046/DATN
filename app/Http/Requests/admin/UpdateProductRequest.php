...
class UpdateProductRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'variants.*.id.exists' => 'The variant ID does not exist.',
            ...
            'variants.*.images.max' => 'Each variant may not have more than 5 images.',
            'variants.*.images.*.image' => 'Each variant image must be a valid image file.',
            'variants.*.images.*.mimes' => 'Variant images must be JPEG, PNG, JPG, or GIF.',
            'variants.*.images.*.max' => 'Each variant image may not exceed 2MB.',
