...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    dark_flag = false;
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '/images/logo/Apple_Store.png');
    }
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '/images/logo/Apple_Store.png');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '/images/logo/Apple_Store.png');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '/images/logo/Apple_Store.png');
    }
    var control = document.querySelector('.theme-layout > a.active');
    if (control) {
      document.querySelector('.theme-layout > a.active').classList.remove('active');
