<!-- resources/views/admin/products/create-variant.blade.php -->
                        ...
                        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="variant-attributes">
                                    <div class="row mb-2">
                                        <div class="col-md-5">
                                            <select class="form-select" name="attribute_values[0][attribute_type_id]">
                                                <option value="">-- Select Attribute --</option>
                                                @foreach ($attributeTypes as $attributeType)
                                                    <option value="{{ $attributeType->id }}">{{ $attributeType->name }}</option>
                                                @endforeach
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" name="attribute_values[0][values]" placeholder="Values (comma-separated, e.g., Red,Blue,Green)">
                                        </div>
                                        <div class="col-md-2">
