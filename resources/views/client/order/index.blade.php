...
<div class="main-content">
    <div class="container pt-5">
        ...
        <ul class="nav nav-tabs mb-4">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request('status') == 'returned' ? 'active' : '' }}" href="{{ route('order.index', ['status' => 'returned']) }}">Đã hoàn đơn</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request('status') == 'partially_returned' ? 'active' : '' }}" href="{{ route('order.index', ['status' => 'partially_returned']) }}">Hoàn một phần</a>
            </li>
            <li class="nav-item">
