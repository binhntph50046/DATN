...
@section('scripts')
<script>
    // Realtime cập nhật trạng thái badge
    ...
    window.Echo.channel('orderStatus.' + orderId)
        .listen('.OrderStatusUpdated', (e) => {
            ...
            badge.className = 'status-badge status-' + (statusClassMap[e.status] || 'secondary');
            badge.innerHTML = `<i class="fas ${statusIconMap[e.status] || 'fa-circle'}"></i> <span id="order-status-text">${e.status_text}</span>`;
        });
</script>
@endsection
